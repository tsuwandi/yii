 ...
 */
class FrontBannerBase extends ActiveRecord
{
	public function tableName()
	{
		return 'tblpa_front_banner';
	}
	...
	public function rules()
	{
		return array(
			...
			array('file', 'file', 'types' => 'jpg, gif, png', 'maxSize' => 1024 * 1024 * 10, 'allowEmpty' => true,
				...
				'tooLarge' => 'The file was larger than 10MB. Please upload a smaller file.', 'on' => 'insert, uploadImage'),
