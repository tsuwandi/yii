...
<div class="row">
		<?php echo $form->labelEx($model,'buildCustom'); ?>
		<?php echo $form->checkBox($model,'buildCustom'); ?>
		<div class="tooltip">
			Whether custom model class should be generated and reset to empty code.
			You should disable this option if your custom model class has already contained custom codes.
		</div>
		<?php echo $form->error($model,'buildCustom'); ?>
	</div>
