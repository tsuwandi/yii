	...
	$this->widget('bootstrap.widgets.TbGridView', array(
		...
		'columns' => array(
			array(
				'header' => 'Image',
				'type' => 'raw',
				'value' => 'CHtml::image(Yii::app()->baseUrl."/images/partner/".$data->filename,"",array("style"=>"width:50%; margin-left:100px;"))',
