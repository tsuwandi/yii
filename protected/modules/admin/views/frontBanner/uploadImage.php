<?php 
    $this->menu = array(
        ...
        array('label' => 'Create Front Banner', 'url'=>array('admin')),
...
<fieldset>
    ...
    <legend><?php echo ucfirst($this->action->id); ?> Banner</legend>
    ...
    <?php echo $form->errorSummary($model); ?>
        ...
        <?php if (!$model->isNewRecord):?>
             <?php echo TbHtml::thumbnails(array(array('image' => Yii::app()->baseUrl. '/images/frontBanner/' . $model->filename, 'url' => '#')), array('style' => 'margin-left:150px;')); ?>
        <?php endif; ?>
